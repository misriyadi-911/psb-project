...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Siswa/</span>Detail Data Siswa</h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            <div class="row">
              <div col>
              <a href="/siswa/download-data/{{ $data_siswa->id }}">
                <button type="button" class="btn btn-success mb-3 inline">
                  <i class='menu-icon tf-icons bx bx-download'></i> Download Data
                </button>
                </a>
            ...
            <form action="" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div class="input-group">
                        ...
                        <input type="file" name="foto" class="form-control" id="inputGroupFile02" value="{{ old('foto') }}" accept=".jpg, .jpeg, .png" disabled/>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Tingkat <small class="text-danger">*</small></label>
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        <span id="basic-icon-default-fullname2" class="input-group-text"
                        ...
                        <input
                          ...
                          aria-describedby="basic-icon-default-fullname2"
                          name="tingkat"
                          value="@if($data_siswa->tingkat == 1)MTs @elseif($data_siswa->tingkat == 2)SMP @elseif($data_siswa->tingkat == 3)MA                             
                            @endif
                           "
                          disabled
                        />
                ...
                <div class="row mt-3">
                    <label class="col-sm-2 col-form-label" for="">Tempat/Tanggal Lahir <small class="text-danger">*</small></label>
                        <div class="col-sm-5">
                            <input disabled name="tempat_lahir" class="form-control" type="text" placeholder="Kota kelahiran" id="html5-date-input" value="{{ $data_siswa->tempat_lahir }}"/>
                        </div>
                        <div class="col-sm-5">
                            <input disabled name="tanggal_lahir" class="form-control" type="date" placeholder="2021-06-18" id="html5-date-input" value="{{ $data_siswa->tanggal_lahir }}"/>
                        </div>
                  </div>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input disabled type="file" name="kk" class="form-control" id="inputGroupFile03" accept=".pdf"/>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input disabled type="file" name="akte" class="form-control" id="inputGroupFile04" accept=".pdf"/>
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                      <div class="input-group">
                        ...
                        <input disabled type="file" name="raport" class="form-control" id="inputGroupFile05" accept=".pdf"/>
                ...
                <div class="row mt-3">
                  <label class="col-sm-2 col-form-label" for="">Tempat/Tanggal Lahir <small class="text-danger">*</small></label>
                      <div class="col-sm-5">
                          <input disabled name="tempat_lahir_ayah" class="form-control" type="text" placeholder="Kota kelahiran" id="html5-date-input" value="{{ $data_orang_tua[0]->tempat_lahir_ayah }}"/>
                      </div>
                      <div class="col-sm-5">
                          <input disabled name="tanggal_lahir_ayah" class="form-control" type="date" placeholder="2021-06-18" id="html5-date-input" value="{{ $data_orang_tua[0]->tanggal_lahir_ayah }}"/>
                      </div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select disabled name="pendidikan_ayah" class="form-select" id="inputGroupSelect02">
                ...
                <div class="row mt-3">
                  <label class="col-sm-2 col-form-label" for="">Tempat/Tanggal Lahir <small class="text-danger">*</small></label>
                      <div class="col-sm-5">
                          <input disabled name="tempat_lahir_ibu" class="form-control" type="text" placeholder="Kota kelahiran" id="html5-date-input" value="{{ $data_orang_tua[0]->tempat_lahir_ibu }}"/>
                      </div>
                      <div class="col-sm-5">
                          <input disabled name="tanggal_lahir_ibu" class="form-control" type="date" placeholder="2021-06-18" id="html5-date-input" value="{{ $data_orang_tua[0]->tanggal_lahir_ibu }}"/>
                      </div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select disabled name="pendidikan_ibu" class="form-select" id="inputGroupSelect02">
                ...
                <div class="row mt-3">
                  <label class="col-sm-2 col-form-label" for="">Tempat/Tanggal Lahir <small class="text-danger">*</small></label>
                      <div class="col-sm-5">
                          <input disabled name="tempat_lahir_wali" class="form-control" type="text" placeholder="Kota kelahiran" id="html5-date-input" value="{{ $data_orang_tua[0]->tempat_lahir_wali }}"/>
                      </div>
                      <div class="col-sm-5">
                          <input disabled name="tanggal_lahir_wali" class="form-control" type="date" placeholder="2021-06-18" id="html5-date-input" value="{{ $data_orang_tua[0]->tanggal_lahir_wali }}"/>
                      </div>
                </div>
                <div class="row mt-3">
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select disabled name="pendidikan_wali" class="form-select" id="inputGroupSelect02">
                ...
                <div class="row mt-4 justify-content-end">
                  <div class="col-sm-10">
                    <a href="/siswa/mts" class="btn btn-success">
                      Kembali
                    </a>
                  </div>
                </div>
