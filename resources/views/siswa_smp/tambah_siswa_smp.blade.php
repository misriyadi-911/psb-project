      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            @endif
            <form action="/siswa/smp/tambah" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="">Kelas<small class="text-danger">*</small></label>
                    <div class="col-sm-10">
                      ...
                      @foreach($data_kelas as $data)
                        <div class="form-check form-check-inline mt-1">
                          <input
                            ...
                            value="{{$data->kelas}}"
                            name="kelas"
                            {{ old('kelas', $data_siswa->kelas ?? '') === $data->kelas ? 'checked' : '' }}
                          />
                          <label class="form-check-label" for="inlineRadio1">{{$data->kelas}}</label>
                        </div>
                      @endforeach
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select name="pendidikan_ayah" class="form-select" id="inputGroupSelect02">
                              <option selected value="{{ old('pendidikan_ayah') }}">{{ old('pendidikan_ayah') }}</option>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select name="pendidikan_ibu" class="form-select" id="inputGroupSelect02">
                              <option selected value="{{ old('pendidikan_ibu') }}">{{ old('pendidikan_ibu') }}</option>
                              <option value="SD">SD</option>
                              <option value="SMP">SMP</option>
                              <option value="SMA">SMA</option>
                              <option value="D3">D3</option>
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-merge">
                            <select name="pendidikan_wali" class="form-select" id="inputGroupSelect02">
                              <option selected value="{{ old('pendidikan_wali') }}">{{ old('pendidikan_wali') }}</option>
                              <option value="SD">SD</option>
                              <option value="SMP">SMP</option>
                              <option value="SMA">SMA</option>
                              <option value="D3">D3</option>
