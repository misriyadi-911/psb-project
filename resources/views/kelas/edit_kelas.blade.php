...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Kelas/</span> Edit Data Kelas </h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            @endif
            <form action="/kelas/update" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
