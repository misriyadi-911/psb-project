...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Siswa/</span>Tambah Data Siswa</h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            <div class="row">
              <div col>
                <a href="{{ asset('doc') }}/template_siswa.xlsx">
                <i class='menu-icon tf-icons bx bx-download'></i> Download Template Disini
                </a>
                <hr>
              </div>
            </div>
            
            <form action="/siswa/upload" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">File Data Siswa (Excel)<small class="text-danger">*</small></label>
                  <div class="col-sm-10">
                    <div class="input-group">
                        <input type="file" name="file-data" class="form-control" id="inputGroupFile02" value="{{ old('file-data') }}"/>
                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                    </div>
                    <small class="form-text">* File dapat berupa excel atau berformat excel</small> <br>
                    <small class="form-text">* Maksimal Size 5 MB.</small>
                  </div>
                </div>
