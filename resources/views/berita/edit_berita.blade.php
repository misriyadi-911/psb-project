...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Berita/</span> Edit Data Berita Harian </h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            @endif
            <form action="/berita/update" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  ...
                  <input type="hidden" name="foto_lama" value="{{ $data_berita->foto }}">
                  <div class="col-sm-10">
                    <div class="input-group">
                        <input type="file" name="foto" value="{{ $data_berita->foto }}" class="form-control" id="inputGroupFile02" />
                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                    </div>
                    ...
                    <div class="col-sm-10">
                      <div class="input-group input-group-merge">
                        ...
                        <input
                          ...
                          aria-describedby="basic-icon-default-fullname2"
                          name="tanggal_terbit"
                          value="{{ $data_berita->tanggal_terbit }}"
                        />
                      </div>
                    </div>
                </div>
