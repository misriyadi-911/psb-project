...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/</span> Data Berita Harian</h4>
                  ...
                  <div class="table-responsive text-nowrap">
                    <table class="table table-bordered">
                      ...
                      @foreach($data_berita as $data)
                          <tr>
                            <td>
                              <img src="{{ asset('img') }}/{{ $data->foto }}" width="70px">
                            </td>
                            <td><i class="fab fa-angular fa-lg text-danger"></i> <strong>{{ $data->judul }}</strong></td>
                            <td> {{ $data->tanggal_terbit }}</td>
                            <td>{{ $data->penulis }}</td>
                            <td><?php echo implode (' ', array_slice(explode(' ', $data->isi), 0,5)). '...';?></td>
                            <td>
                              <div class="dropdown">
                                <button
                                  type="button"
                                ...
                                <div class="dropdown-menu">
                                  <a class="dropdown-item" href="{{ url('/berita/edit') }}/{{ $data->id }}"
                                    ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                  >
                                  <a class="dropdown-item" href="{{ url('/berita/hapus') }}/{{ $data->id }}"
