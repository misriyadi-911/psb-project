...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/</span> Data Guru</h4>
                        ...
                        <tr>
                          <td>
                            <ul class="list-unstyled users-list m-0 avatar-group d-flex align-items-center">
                              ...
                              >
                                <img src="{{ asset('img') }}/{{ $data->foto_guru }}" alt="Avatar" class="rounded-circle" />
                              </li>
                            </ul>
                          </td>
                          <td>
                            <i class="fab fa-angular fa-lg text-danger"></i> <strong>{{ $data->nama }}</strong>
                          </td>
                          ...
                          <td>
                            <div class="dropdown">
                              ...
                              <div class="dropdown-menu">
                                <a class="dropdown-item" href="{{ url('/guru/edit') }}/{{ $data->id }}"
                                  ><i class="bx bx-edit-alt me-1"></i> Edit</a
                                >
                                <a class="dropdown-item" href="{{ url('/guru/hapus') }}/{{ $data->id }}"
