...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Guru/</span> Tambah Data Guru </h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            @endif
            <form action="/guru/tambah" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                    ...
                    <div class="form-check form-check-inline mt-1">
                        <input
                          ...
                          value="Ikhwan"
                          name="jenis_kelamin"
                          {{ old('jenis_kelamin', $data_guru->jenis_kelamin ?? '') === 'Ikhwan' ? 'checked' : '' }}
                        />
                      ...
                      <div class="form-check form-check-inline">
                        <input
                          ...
                          value="Akhwat"
                          name="jenis_kelamin"
                          {{ old('jenis_kelamin', $data_guru->jenis_kelamin ?? '') === 'Akhwat' ? 'checked' : '' }}
                        />
