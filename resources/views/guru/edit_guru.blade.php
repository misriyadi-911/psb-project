...
<body>
 ...
 <div class="content-wrapper">
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
      <h4 class="fw-bold py-3 mb-4 text-primary"><span class="text-muted fw-light">Admin/Guru/</span> Edit Data Guru </h4>
      ...
      <div class="row">
        ...
        <div class="col-xl">
          ...
          <div class="card mb-4">
            ...
            @endif
            <form action="/guru/update" id="form-pendaftaran" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Foto Guru <small class="text-danger">*</small></label>
                  <div class="col-sm-10">
                    <div class="input-group">
                        <input type="file" name="foto_guru" class="form-control" id="inputGroupFile02" />
                        <input type="hidden" name="id" value="{{ $data_guru->id }}">
                        <input type="hidden" name="foto_lama" value="{{ $data_guru->foto_guru }}">
                        <label class="input-group-text" for="inputGroupFile02">Upload</label>
                    </div>
                ...
                <div class="row mb-3">
                    <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Nama<small class="text-danger">*</small></label>
                    <div class="col-sm-10">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-5">
                      <input name="tempat_lahir" class="form-control" type="text" placeholder="Kota kelahiran" id="html5-date-input" value="{{ $data_guru->tempat_lahir }}"/>
                  </div>
                  <div class="col-sm-5">
                      <input name="tanggal_lahir" class="form-control" type="date" placeholder="2021-06-18" id="html5-date-input" value="{{ $data_guru->tanggal_lahir }}"/>
                  </div>
                </div>
                <div class="row mb-3">
                    ...
                    <div class="form-check form-check-inline mt-1">
                        <input
                          ...
                          value="Ikhwan"
                          name="jenis_kelamin"
                          {{ $data_guru->jenis_kelamin === 'Ikhwan' ? 'checked' : '' }}
                        />
                      ...
                      <div class="form-check form-check-inline">
                        <input
                          ...
                          value="Akhwat"
                          name="jenis_kelamin"
                          {{ $data_guru->jenis_kelamin === 'Akhwat' ? 'checked' : '' }}
                        />
                ...
                <!-- <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Jabatan<small class="text-danger">*</small></label>
                  <div class="col-sm-10">
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-user"></i
                ...
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">Alamat<small class="text-danger">*</small></label>
                  <div class="col-sm-10">
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
                        ><i class="bx bx-map"></i
                      ...
                      <textarea
                        ...
                        aria-describedby="basic-icon-default-fullname2"
                        name="alamat"
                      >{{ $data_guru->alamat }}</textarea>
                    </div>
                  </div>                
                </div>
                <div class="row mb-3">
                  <label class="col-sm-2 col-form-label" for="basic-icon-default-fullname">TMT<small class="text-danger">*</small></label>
                  <div class="col-sm-10">
                    <div class="input-group input-group-merge">
                      <span id="basic-icon-default-fullname2" class="input-group-text"
